...
class _UpdatePageState extends State<UpdatePage> {
  ...
  TextEditingController tecJumlah = TextEditingController();
  TextEditingController tecHarga = TextEditingController();
  TextEditingController tecTotal = TextEditingController();
  ...
  void initState() {
    super.initState();
    id = widget.data.id;
    tecTanggal = TextEditingController(text: widget.data.tanggal);
    tecNama = TextEditingController(text: widget.data.nama_pakaian);
    valueJenis = widget.data.jenis_pakaian;
    valueUkuran = widget.data.ukuran;
    tecJumlah = TextEditingController(text: widget.data.jumlah_pakaian.toString());
    tecHarga = TextEditingController(text: widget.data.harga_pakaian.toString());
    tecTotal = TextEditingController(text: widget.data.total.toString());
  }
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    if(formKey.currentState!.validate()){
                      ...
                      await apiService.updateData(id,tecTanggal.text.toString(),
                          tecNama.text.toString(),valueJenis.toString(),valueUkuran.toString(),
                          jumlah,harga,total_);
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text('Update Data berhasil disimpan')));
